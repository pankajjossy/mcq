            ...
            {!draftQuestions ? (
              <>
                ...
                <p className="muted" style={{ marginTop: 10 }}>
                  Generating is only for the multiple-choice-family types above. If you only want a
                  short-answer/essay paper, skip generating - just check the box above, save the short-answer
                  questions below, and click Done.
                </p>
              </>
            ) : (
              <>
